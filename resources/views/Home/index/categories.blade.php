...
@section('content')
    @if(auth()->user())
        ...
        <main _ngcontent-c0="">
            ...
            <search _nghost-c23="" class=""><div _ngcontent-c23="" class="searchPage">

                    <div _ngcontent-c23="" class="container first">
                        <div _ngcontent-c23="" class="searchBar flex-row jus-between al-center wrapped">
                            <!----><div _ngcontent-c23="" class="catIcon flex-row jus-center al-center" style="background-color: rgb(125, 102, 158);">
                            ...
                            <div _ngcontent-c23="" class=" searchTools">
                                <div _ngcontent-c23="" class="boxAndFilters wi-100 flex-row jus-between al-center ">
                                    ...
                                    <div _ngcontent-c23="" class="searchBoxWrap wi-xl-55 wi-lg-70 wi-md-100 wi-sm-90 wi-xs-100">
                                        <search-box _ngcontent-c23="" _nghost-c10="" class="ng-tns-c10-5">
                                            <div _ngcontent-c10="" class="searchBoxWrap wi-100" outclick="">
                                                ...
                                                <form _ngcontent-c10="" class="searchBox wi-100 firstStyle ng-pristine ng-valid ng-touched" novalidate="">
                                                    <input _ngcontent-c10="" class="wi-100 ng-pristine ng-valid ng-touched" autocomplete="off" name="search-input" title="جستجو" type="text" placeholder="جستجو در دوره‌های انیمیشن و سه‌بعدی">
                                                    <a _ngcontent-c10="" class="searchButton flex-row jus-center al-center" rel="animation-3d" href="/animation-3d/keyword-/label-none/page-1">
                                                ...
                                                <!---->
                                            </div><style></style></search-box>
                                    </div>
                                    <div _ngcontent-c23="" class="filtersWrap wrapped">
                                        <div _ngcontent-c23="" class="priceFilter filterWrapp flex-row al-center">
                                            <div _ngcontent-c23="" class="filters selected">همه</div>
                                            <div _ngcontent-c23="" class="divider" style="background-color: transparent;"></div>
                                            <div _ngcontent-c23="" class="filters">خریدنی</div>
                                            <div _ngcontent-c23="" class="divider"></div>
                                            <div _ngcontent-c23="" class="filters">رایگان</div>
                                        </div>
                                        <div _ngcontent-c23="" class="sortSelect flex-row jus-center al-center">
                                            <div _ngcontent-c23="" class="selectHolder" outclick="">
                                                <div _ngcontent-c23="" class="arrow">
                                                    <!----><i _ngcontent-c23="" class="fw-arrow-down-8-filled"></i>
                                                    <!---->
                                                </div>
                                                <select _ngcontent-c23="" class="wi-100 ng-untouched ng-pristine ng-valid">
                                                    <!----><option _ngcontent-c23="" class="opts" value="0: none"><span _ngcontent-c23="">مرتبط‌ترین</span></option><option _ngcontent-c23="" class="opts" value="1: price"><span _ngcontent-c23="">قیمت</span></option><option _ngcontent-c23="" class="opts" value="2: duration"><span _ngcontent-c23="">مدت زمان دوره</span></option><option _ngcontent-c23="" class="opts" value="3: publish_date"><span _ngcontent-c23="">تاریخ انتشار</span></option>
                                                </select>
                                            </div>
                                            <div _ngcontent-c23="" class="divider"></div>
                                            <div _ngcontent-c23="" class="sortDirection flex-row jus-center al-center ">
                                                <!----><i _ngcontent-c23="" aria-hidden="true" class="fas fa-database"></i>
                                                <!---->
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div _ngcontent-c23="" class="container second">
                        ...
                        <div _ngcontent-c23="" class="flex-row jus-center al-start wrapped" style="text-align: center">
                                    ...
                                    <!----><div _ngcontent-c23="" class="scopeWrapper">
                                        <div _ngcontent-c23="" class="singleScope wi-100">
                                            <div _ngcontent-c23="" class="flex-row jus-between scopeTitle">
                                                <div _ngcontent-c23="" class="scopeName">ابزار و نرم‌افزار</div>
                                                <div _ngcontent-c23="" class="angleHolder flex-row jus-center al-center">
                                                    <i _ngcontent-c23="" aria-hidden="true" class="fa fa-angle-left" style="transform: rotate(90deg);"></i>

                                                </div>
                                            </div>
                                            <div _ngcontent-c23="" class="labelList wi-100" style="height: 213px;">
                                                <div _ngcontent-c23="" class="topLine"></div>

                                                <!----><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label80">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label80"> 3Ds Max</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label86">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label86"> Houdini</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label87">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label87"> Modo</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label82">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label82"> Silo</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label83">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label83"> VRay</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label84">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label84"> Vue xStream</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label85">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label85"> ZBrush</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label152">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label152"> ساخت یونیتی</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label78">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label78"> مایا</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label79">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label79"> یونیتی</label>
                                                    </div>

                                                </div>
                                                <!----><p _ngcontent-c23="">موارد بیشتر (۵+)
                                                </p>
                                            </div>
                                        </div>
                                    </div><div _ngcontent-c23="" class="scopeWrapper">
                                        <div _ngcontent-c23="" class="singleScope wi-100">
                                            <div _ngcontent-c23="" class="flex-row jus-between scopeTitle">
                                                <div _ngcontent-c23="" class="scopeName">سرفصل</div>
                                                <div _ngcontent-c23="" class="angleHolder flex-row jus-center al-center">
                                                    <i _ngcontent-c23="" aria-hidden="true" class="fa fa-angle-left" style="transform: rotate(90deg);"></i>
                                            ...
                                            <div _ngcontent-c23="" class="labelList wi-100" style="height: 213px;">
                                                ...
                                                <!----><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label75">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label75"> انیمیشن</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label77">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label77"> بازی سازی</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label73">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label73"> تکسچر</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label139">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label139"> دوره‌های پیشنهادی انیمیشن و سه‌بعدی</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label72">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label72"> مدل‌سازی</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label76">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label76"> نقاشی ۳بعدی</label>
                                                    </div>

                                                </div><div _ngcontent-c23="" class="singleLabel flex-row jus-start">
                                                    <div _ngcontent-c23="" class="checkbox1Wrap flex-row jus-center al-center">
                                                        <input _ngcontent-c23="" class="checkbox1 ng-pristine ng-untouched ng-valid ng-not-empty" name="radio" type="checkbox" id="label74">

                                                        <label _ngcontent-c23="" id="lblRadio1" for="label74"> نورپردازی</label>
                                                    </div>

                                                </div>
                                                <!----><p _ngcontent-c23="">موارد بیشتر (۲+)
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div _ngcontent-c23="" class="resultsCol flex-row jus-start wrapped wi-md-75 wi-sm-100 wi-xs-100">
                                                        ...
                                                        <!----><a _ngcontent-c20=""
                                                            ...
                                                            <h3 _ngcontent-c20=""
                                                                ...
                                                                <!----><a _ngcontent-c20=""
                                                                    ...
                                                                    <span _ngcontent-c20="" class="authorName">{{$course->user->name}}</span>
                                                                </a>
                                                            </h3>
                                                            <div _ngcontent-c20=""
                                                                ...
                                                                <div _ngcontent-c20=""
                                                                    ...
                                                                    @else
                                                                        <div _ngcontent-c18="" class="contentPrice flex-col al-center">
                                                                            <!---->
                                                                            <div _ngcontent-c18="" class="endPrice">
                                                                                {{$course->price}}
                                                                            </div>
                            ...
                            <search-box _ngcontent-c12="" _nghost-c10="" class="ng-tns-c10-4">
                                <div _ngcontent-c10="" class="searchBoxWrap wi-100" outclick="">
                                    ...
                                    <form _ngcontent-c10=""
                                        ...
                                        <a _ngcontent-c10="" class="searchButton flex-row jus-center al-center" rel="all"
                                                            ...
                                                            <div _ngcontent-c18=""
                                                                ...
                                                                <div _ngcontent-c18=""
                                                                    ...
                                                                    <div _ngcontent-c18=""
                                                                        ...
                                                                        <!----><span
                                                                            _ngcontent-c18="" style="margin-left: 3px">{{$course->time}}</span>
                                                                        <!---->
                                                                        <i class="fas fa-clock"></i>
                        ...
                        <div _ngcontent-c12="" class="flex-row wi-100 jus-around wrapped">
                            <!----><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(57, 189, 222);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/education">

                                        <i _ngcontent-c21="" class="fas fa-school"></i>
                                        <div _ngcontent-c21="" class="catTitle">مدرسه و دانشگاه</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(57, 189, 222);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(229, 154, 19);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/design">

                                        <i _ngcontent-c21="" class="fas fa-palette"></i>
                                        <div _ngcontent-c21="" class="catTitle">طراحی</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(229, 154, 19);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(204, 95, 55);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/cooking">

                                        <i _ngcontent-c21="" class="fas fa-cocktail"></i>
                                        <div _ngcontent-c21="" class="catTitle">آشپزی</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(204, 95, 55);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(246, 190, 120);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/other">

                                        <i _ngcontent-c21="" class="fas fa-oil-can"></i>
                                        <div _ngcontent-c21="" class="catTitle">گوناگون</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(246, 190, 120);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(204, 95, 55);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/digilife">
                                ...
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(4, 145, 131);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/foreign-languages">

                                        <i _ngcontent-c21="" class="icon icon-faranesh-font-5"></i>
                                        <div _ngcontent-c21="" class="catTitle">زبان‌های خارجی</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(4, 145, 131);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(48, 121, 171);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/network-security">

                                        <i _ngcontent-c21="" class="icon icon-faranesh-font-21"></i>
                                        <div _ngcontent-c21="" class="catTitle">شبکه و امنیت</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(48, 121, 171);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(92, 184, 96);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/programming">

                                        <i _ngcontent-c21="" class="icon icon-faranesh-font-30"></i>
                                        <div _ngcontent-c21="" class="catTitle">برنامه‌نویسی</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(92, 184, 96);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(232, 84, 91);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/web">

                                        <i _ngcontent-c21="" class="icon icon-faranesh-font-23"></i>
                                        <div _ngcontent-c21="" class="catTitle">وب</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(232, 84, 91);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(158, 53, 158);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/film-audio">

                                        <i _ngcontent-c21="" class="icon icon-faranesh-font-13"></i>
                                        <div _ngcontent-c21="" class="catTitle">فیلم و صدا </div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(158, 53, 158);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(125, 102, 158);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/animation-3d">

                                        <i _ngcontent-c21="" class="icon icon-faranesh-font-10"></i>
                                        <div _ngcontent-c21="" class="catTitle">انیمیشن و سه‌بعدی</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(125, 102, 158);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card><category-card _ngcontent-c12="" _nghost-c21="">
                                <div _ngcontent-c21="" class="catCardParent" style="border-color: rgb(99, 122, 145);">
                                    <a _ngcontent-c21="" class="flex-col jus-center al-center wi-100 hi-100" href="/business">

                                        <i _ngcontent-c21="" class="icon icon-faranesh-font-18"></i>
                                        <div _ngcontent-c21="" class="catTitle">کسب‌وکار</div>
                                    </a>

                                    <div _ngcontent-c21="" class="theBg" style="background-color: rgb(99, 122, 145);"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff1"></div>
                                    <div _ngcontent-c21="" class="dropEff dropEff2"></div>
                                </div></category-card>
                        </div>
                        <a _ngcontent-c12="" href="/search/keyword-/label-none/page-1">
                            <h4 _ngcontent-c12=""><i _ngcontent-c12="" aria-hidden="true" class="fa fa-caret-left"></i> دوست داری چه چیزی یاد بگیری؟ </h4>
                        </a>
                    </div>
                </section>
            </home-unreg>
