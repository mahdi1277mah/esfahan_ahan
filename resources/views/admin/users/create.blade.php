                ...
                <div class="body">
                    <div class="table-responsive">
                        <form action="{{route('admin.users.store')}}" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name"
                                           placeholder="لطفا نام و نام خانوادگی را وارد کنید" value="{{old('name')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="email" class="form-control" name="email" id="email"
                                           placeholder="لطفا ایمیل خود را وارد کنید" value="{{old('email')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="is_superuser" id="is_superuser">
                                        ...
                                        <option value="1"> مدیرکل سایت</option>
                                    </select>
                                </div>
                                @endcan
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="vendor" id="vendor">
                                        <option value="0"> ----- </option>
                                        <option value="1"> نویسنده سایت </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-success">ایجاد کاربر جدید</button>
                                </div>
                            </div>
